...
file_path = '{0}/sub2_{1}.txt'.format(path_dir, arg)
...
if (os.path.exists('{0}/json/dict2_{1}.json'.format(path_dir, arg))):
...
###########################-SUMARY-#########################################################
#print json_dict
with open('{0}/json/dict2_{1}.json'.format(path_dir, arg), 'w') as outfile:
