...
file_path = '{0}/sub1_{1}.txt'.format(path_dir, arg)
...
def Wordcount_Thai(text):
    ...
    with open('/home/tengmo/crawler_to_server_set_time/crawler/output_thai/git/word-parser-noPartOfSpeech/wordcut/input.txt' , 'w') as out:
        out.write(text)
    #print(datainput)
    command= os.popen("bash /home/tengmo/crawler_to_server_set_time/crawler/dynamic_section/soucecode/run_java.bash")
    datainput = command.read()
    #print(datainput)
    with open('/home/tengmo/crawler_to_server_set_time/crawler/output_thai/git/word-parser-noPartOfSpeech/wordcut/output.csv', 'r') as csvfile:
...
if (os.path.exists('{0}/json/dict1_{1}.json'.format(path_dir, arg))):
    print "dict1_%s already exists"%arg
    sys.exit()
####################################-Rotate-###############################################
cnt_begin = 0
cnt_end = 1
...
###########################-SUMARY-#########################################################
#print json_dict
with open('{0}/json/dict1_{1}.json'.format(path_dir, arg), 'w') as outfile:
