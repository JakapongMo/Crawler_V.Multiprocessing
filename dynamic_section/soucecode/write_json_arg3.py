...
def Wordcount_Thai(text):
    ...
    with open('/home/tengmo/crawler_to_server_set_time/crawler/output_thai/git/word-parser-noPartOfSpeech/wordcut3/input.txt' , 'w') as out:
        out.write(text)
    #print(datainput)
    command= os.popen("bash /home/tengmo/crawler_to_server_set_time/crawler/dynamic_section/soucecode/run_java3.bash")
    datainput = command.read()
    #print(datainput)
    with open('/home/tengmo/crawler_to_server_set_time/crawler/output_thai/git/word-parser-noPartOfSpeech/wordcut3/output.csv', 'r') as csvfile:
...
if (os.path.exists('{0}/json/dict3_{1}.json'.format(path_dir, arg))):
...
###########################-SUMARY-#########################################################
#print json_dict
with open('{0}/json/dict3_{1}.json'.format(path_dir, arg), 'w') as outfile:
